...
function callResults(){
    ...
    var startDate = new Date(startDatePage);
        startDate.setHours(currentDate.getHours() + 22);//these are set to 22 because there is no set Day function and i needed to subtract 2 hours and add one day
        startDate.setMinutes(currentDate.getMinutes());
    var endDate = new Date(endDatePage);
        endDate.setHours(currentDate.getHours() + 22);
    ...
    .then(function(data) {
        ...
        header.appendChild(document.createTextNode("Aircraft Billing Report - " + getTime() + " UTC"));
